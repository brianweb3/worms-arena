...
export class Terrain {
    ...
    height;
    data;
    constructor(width = MAP_WIDTH, height = MAP_HEIGHT, data) {
        this.width = width;
        this.height = height;
    ...
    static fromBase64(encoded, width, height) {
        let u8;
        if (typeof Buffer !== 'undefined') {
...
export function generateTerrain(rng, width = MAP_WIDTH, height = MAP_HEIGHT) {

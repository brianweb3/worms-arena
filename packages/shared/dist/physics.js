 ...
 */
export function simulateProjectile(startX, startY, vx, vy, weaponId, wind, terrain, worms) {
 ...
 */
export function applyExplosion(explosion, terrain, worms) {
    // Destroy terrain
 ...
 */
export function applyWormGravity(terrain, worms) {
    const deaths = [];
    for (const worm of worms) {
        if (!worm.alive)
            continue;
